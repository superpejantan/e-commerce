<a href="offer.html"><img src="{{asset('tokonline/images/download.png')}}" class="img-head" alt=""></a>
<div class="header">
		...
		<div class="container">
			...
			<div class="head-t">
				<ul class="card">
					<li><a href="{{url('keranjang')}}" ><i class="fa fa-heart" aria-hidden="true"></i>Wishlist</a></li>
					...
					<li><a href="{{url('invoice/list')}}" ><i class="fa fa-file-text-o" aria-hidden="true"></i>Order History</a></li>
					<li><a href="{{url('konfirmasi')}}" ><i class="fa fa-money" aria-hidden="true"></i>Konfirmasi</a></li>
					<li><a href="{{url('keluar')}}" ><i class="fa fa-arrow-left" aria-hidden="true"></i>Log out</a></li>
					<br>
				<h1><li><a href="{{url('keranjang')}}" ><i class="fa fa-user" aria-hidden="true"></i></a></li></h1>
				</ul>	
			</div>
				...
				<div class="nav-top">
					...
					<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
						<ul class="nav navbar-nav ">
							...
							<li><a href="contact.html" class="hyper"><span>Contact Us</span>{{Cart::Total()}}</a></li>
						</ul>
					</div>
					</nav>
					 <div class="cart" >
					
						<span class="fa fa-shopping-cart my-cart-icon"><span class="badge badge-notify my-cart-badge">{{count(Cart::content())}}</span></span>
					</div>
					<div class="clearfix"></div>
				</div>
